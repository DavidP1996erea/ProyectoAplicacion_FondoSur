...
namespace PregunFondoSur.models
{
    public class clsObtenerListadoCategorias
    {
        public static List<clsCategoriasMaui> obtenerListadoCompletoCategorias()
        {
            ...
            listaCategorias.Add(new clsCategoriasMaui("Film & TV", "videobase.png", "videoganado.png", "videobase.png", false));
            ...
            listaCategorias.Add(new clsCategoriasMaui("Food & Drink", "foodbase.png", "foodganado.png", "foodbase.png", false));
